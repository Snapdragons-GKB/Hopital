...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('providerProfile', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Provider',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_ailment_category', models.CharField(choices=[('0', 'None'), ('1', 'General Medicine'), ('2', 'Orthopedics'), ('3', 'Cardiology'), ('4', 'Neurology'), ('5', 'Pediatrics'), ('6', 'Emergency'), ('7', 'Psychiatry'), ('8', 'Radiology'), ('9', 'Internal Medicine'), ('10', 'Other')], default='0', max_length=20)),
